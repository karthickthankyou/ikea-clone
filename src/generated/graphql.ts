...
export type GetOrderedProductsQuery = {
  __typename?: 'query_root'
  orders: Array<{
    __typename?: 'orders'
    id: any
    pid: number
    updatedAt: any
    product: { __typename?: 'products'; images?: any | null; name: string }
  }>
  orders_aggregate: {
    __typename?: 'orders_aggregate'
    aggregate?: { __typename?: 'orders_aggregate_fields'; count: number } | null
  }
}
...
export function useGetOrderedProductsQuery(
  options?: Omit<Urql.UseQueryArgs<GetOrderedProductsQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetOrderedProductsQuery>({
    query: GetOrderedProductsDocument,
    ...options,
  })
}
...
export function useGetViewedProductsQuery(
  options?: Omit<Urql.UseQueryArgs<GetViewedProductsQueryVariables>, 'query'>
) {
  return Urql.useQuery<GetViewedProductsQuery>({
    query: GetViewedProductsDocument,
    ...options,
  })
}
